...
class Config {
 public:
  ...
  std::string query_prediction_error_path_;
  ...
  std::string test_dataset_filename_; // filename for storing global query test dataset
  ...
  bool load_precalculated_errors_;
  std::string precalculated_errors_filepath_;
  ...
  ID_TYPE auto_fit_max_degree_;
  bool use_train_optimal_polynomial_model_;
